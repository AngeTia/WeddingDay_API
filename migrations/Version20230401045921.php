 ...
 */
final class Version20230401045921 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE recu_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE SEQUENCE "user_id_seq" INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE TABLE recu (id INT NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE recu_id_seq CASCADE');
